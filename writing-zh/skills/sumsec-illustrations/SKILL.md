...
默认人物角色是“SumSec Observer”：SumSec 在白纸工程草图里的个人化分身。它是克制、冷静、长期写 sumsec.me、做安全研究、Agent 工程和个人 Skill 仓库的人，而不是品牌吉祥物。设计来源来自 sumsec.me 的“清水般透明”气质、青蓝水滴 S 图标、GitHub profile 中的深色短发/手势/双戒指信号，以及角色设定图里的细框眼镜、冷灰连帽夹克、暗青蓝包带、斜挎工具包、夹板/日志纸和胸前调查牌；只做原创转译，不复刻头像画风或设定图构图。稳定外观：年轻成人比例、自然挺直的脊背与稳定站姿、深炭干净轮廓线、少量发丝线、深墨或深棕黑短发、略凌乱侧分、细框眼镜优先于低檐帽、明亮放松的窄眼、轻微笑意、干净下颌、无胡子/胡茬/小胡子、带低饱和局部色彩的短外套或轻量连帽夹克、斜挎工具包、固定青蓝识别件、红橙证据标签、一个低调 SummerSec 铭牌。人物本身不能只是黑白线稿；默认要有克制的色彩锚点：冷灰外套、暗青蓝内衬/包带、很浅的暖肤色面部与手部、深墨色头发或帽檐。SummerSec 铭牌默认优先做成胸前工作证/调查牌，挂在胸前拉链旁、夹克胸口或斜挎包带经过胸前的位置；全身构图中可移到工具包或卡扣，但仍要小而可读。SummerSec 徽记以人物手指上的两个低调 S 徽记戒指作为固定识别件出现，也可作为工具芯片、证据封签或小铭牌参与结构，但不能取代人物。
...
- SumSec Observer 人物本身有低饱和局部色彩：冷灰外套、暗青蓝内衬/包带、浅暖肤色面部和手部、深墨色头发或帽檐
...
- 角色保持 SumSec 个人化分身气质：年轻成人安全研究员 / 系统观测员，清醒、放松、有轻微笑意、亲自下场拆问题，不走阴郁冷脸、吉祥物或可爱小人路线

...
description: 生成 SumSec / sumsec.me 风格的中文正文配图。用于用户要求为安全研究、漏洞复盘、AI Agent、Skill 仓库、工程工作流、方法论、流程、结构、状态、隐喻或观点生成“手绘”“正文配图”“文章插图”“配图建议”“shot list”“去标题/改图”等任务；默认使用黑色操作员角色、纯白手绘、少量青蓝/红橙批注、克制冷幽默的工程草图风格。
---
...
默认视觉角色是“SumSec 黑色操作员”：黑色实心、白点眼、细腿、空表情，认真做一件荒诞但成立的工程动作。它必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/operator-ip.md`：黑色操作员的形象、性格、动作库和禁忌。

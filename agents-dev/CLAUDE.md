...
> 插件开发七件套（agent-development / command-development / hook-development / mcp-integration / plugin-settings / plugin-structure / skill-development）请使用 `plugin-dev` 插件，不再在 agents-dev 内重复维护。

...
Agent 开发生态技能集合。继承自 claude-plugins-official 及本仓库 skill。
...
| `agent-development` | `skills/agent-development/SKILL.md` | Agent 开发（plugin-dev 插件） |
| `command-development` | `skills/command-development/SKILL.md` | 命令开发（plugin-dev 插件） |
| `hook-development` | `skills/hook-development/SKILL.md` | Hook 开发（plugin-dev 插件） |
| `mcp-integration` | `skills/mcp-integration/SKILL.md` | MCP 集成（plugin-dev 插件） |

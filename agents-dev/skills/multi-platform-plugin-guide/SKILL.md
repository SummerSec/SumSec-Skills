...
10. `dev-tools/.claude-plugin/plugin.json`、`dev-tools/.codex-plugin/plugin.json`
11. `agents-dev/.claude-plugin/plugin.json`、`agents-dev/.codex-plugin/plugin.json`
12. `claude-md-management/.claude-plugin/plugin.json`、`claude-md-management/.codex-plugin/plugin.json`
13. `hookify/.claude-plugin/plugin.json`、`hookify/.codex-plugin/plugin.json`
